          ...
          <div className="space-y-6 animate-fade-in">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-ink-500 text-sm mt-1">Search all customers — RUNNING and COMPLETE</p>
              </div>
            ...
            {searchResults === null && (
              <div className="flex flex-col items-center justify-center py-20 text-center">
                ...
                <p className="text-ink-700 text-sm mt-1">Results appear as you type — no button needed</p>
              </div>
            )}
            ...
            {searchResults !== null && searchResults.length > 1 && !selectedCustomer && (
              <div className="card overflow-hidden animate-fade-in">
                <div className="px-5 py-3 border-b border-surface-4">
                  <span className="text-xs text-ink-400 uppercase tracking-widest">{searchResults.length} customers found — click a row to view</span>
                </div>
                  ...
                  <tbody>
                    {searchResults.map((c) => (
                      <tr key={c.id} onClick={() => selectCustomerFn(c)} className="cursor-pointer">
                        ...
                        <td><span className="text-ink-400">{(c.retailer as Retailer)?.name || '—'}</span></td>
                        <td>
                          {c.status === 'RUNNING'
